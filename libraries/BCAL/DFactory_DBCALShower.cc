...
// ClearEvent
//------------------
void DFactory_DBCALShower::ClearEvent(DEventLoop *eventLoop)
{
...
// CellRecon()
//------------------
void DFactory_DBCALShower::CellRecon(DEventLoop *eventLoop)
{
//======================================================================
...
// CeleToArray()
//------------------
void DFactory_DBCALShower::CeleToArray(void)
{
...
// PreCluster()
//------------------        
void DFactory_DBCALShower::PreCluster(DEventLoop *eventLoop)
{
...
// Connect(n,m);
//------------------   
void DFactory_DBCALShower::Connect(int n,int m)
{
//----------------------------------------------------------------------
...
// ClusNorm()
//------------------   
void DFactory_DBCALShower::ClusNorm(void)
{
...
// ClusAnalysis()
//------------------  
void DFactory_DBCALShower::ClusAnalysis()
{
//----------------------------------------------------------------------
...
// Clus_Break(ix);
//------------------
void DFactory_DBCALShower::Clus_Break(int nclust)
{
...
// Trakfit()
//------------------ 
void DFactory_DBCALShower::Trakfit(void)
{
       float emin=0.0001;
...
// Fit_ls()
//------------------  
void DFactory_DBCALShower::Fit_ls()
{      
      float a,b,c;
...
//------------------  
void DFactory_DBCALShower::Linefit(int ixyz,int mwt,float &a,
...
//------------------  
float DFactory_DBCALShower::Gammq(float a_gammq,float x_gammq)
{
...
//------------------  
void DFactory_DBCALShower::Gser(float &gamser,float a_gser,float x_gser)
{
//============================================================================
           int itmax=100;
           float eps=3.0e-7;
...
//  Gcf(gammcf,a,x,gln)
//------------------  
void DFactory_DBCALShower::Gcf(float &gammcf,float a_gcf,float x_gcf)
{
//========================================================================
...
// Gammln(xx)
//------------------  
float DFactory_DBCALShower::Gammln(float xx_gln)
{
...
// toString
//------------------
const string DFactory_DBCALShower::toString(void)
{
