/// SC_PTC_ResolvsZPlot in PTC macros directory
...
void SC_PTC_ResolvsZPlot() {
  ...
  gr->SetMaximum(0.4);
  gr->SetMinimum(0.1);
  TFitResultPtr sec1_r1 = gr->Fit("pol1","S","",10,41);
  double sec1_r1_intcp = sec1_r1->Parameter(0);
  double sec1_r1_slope = sec1_r1->Parameter(1);
  TFitResultPtr sec1_r2 = gr->Fit("pol1","S+","",41,54);
