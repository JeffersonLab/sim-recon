...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->AddProcessor(new DEventProcessor_B3pi_eff_missprot()); //register this plugin
		locApplication->AddFactoryGenerator(new DFactoryGenerator_B3pi_eff_missprot()); //register the factory generator
	}
} // "C"
...
// init
//------------------
jerror_t DEventProcessor_B3pi_eff_missprot::init(void)
{
...
// brun
//------------------
jerror_t DEventProcessor_B3pi_eff_missprot::brun(jana::JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DEventProcessor_B3pi_eff_missprot::evnt(jana::JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	locEventWriterROOT->Fill_DataTrees(locEventLoop, "B3pi_eff_missprot");
	...
	*/
	...
	for(size_t loc_i = 0; loc_i < locAnalysisResultsVector.size(); ++loc_i)
	{
		...
		if(!locPassedParticleCombos.empty())
			locEventWriterREST->Write_RESTEvent(locEventLoop, "B3pi_eff_missprot"); //string is part of output file name
	}
	*/
...
int DEventProcessor_B3pi_eff_missprot::Get_FileNumber(JEventLoop* locEventLoop) const
{
...
// erun
//------------------
jerror_t DEventProcessor_B3pi_eff_missprot::erun(void)
{
...
// fini
//------------------
jerror_t DEventProcessor_B3pi_eff_missprot::fini(void)
{
