...
// hnamepath: /occupancy/fdc_cathode_occ_3
// hnamepath: /occupancy/fdc_wire__occ_3

{
	...
	TH2F *fdc_cathode_occ = (TH2F*)gDirectory->FindObjectAny("fdc_cathode_occ_3");
	TH2F *fdc_wire_occ = (TH2F*)gDirectory->FindObjectAny("fdc_wire_occ_3");
