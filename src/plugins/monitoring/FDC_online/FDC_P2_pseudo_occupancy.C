...

{
  ...
  TDirectory *savedir = gDirectory;
    ...
    TH2F *fdc_occ_cell_2 = (TH2F*)gDirectory->FindObjectAny("fdc_occ_plane_07");
    TH2F *fdc_occ_cell_3 = (TH2F*)gDirectory->FindObjectAny("fdc_occ_plane_08");
    TH2F *fdc_occ_cell_4 = (TH2F*)gDirectory->FindObjectAny("fdc_occ_plane_09");
    TH2F *fdc_occ_cell_5 = (TH2F*)gDirectory->FindObjectAny("fdc_occ_plane_10");
    TH2F *fdc_occ_cell_6 = (TH2F*)gDirectory->FindObjectAny("fdc_occ_plane_11");
