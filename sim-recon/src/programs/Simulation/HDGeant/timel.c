 ...
 *
 * $Log$
 * Revision 1.2  2001/09/25 21:39:54  jonesrt
 * -fixed problems compiling with local copy of cernlib routine timel.c
 *  (the cernlib team botched that routine in the 2001 libkernlib.a distribution)
 * -rtj-
 *
