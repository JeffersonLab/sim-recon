// $Id$
//
//    File: DHDDMBCALTruth_factory.cc
...
#include "DHDDMBCALTruth_factory.h"

//------------------
// evnt
//------------------
jerror_t DHDDMBCALTruth_factory::evnt(JEventLoop *loop, int eventnumber)
{
...
// toString
//------------------
const string DHDDMBCALTruth_factory::toString(void)
{
...
// Extract_HDDM
//------------------
jerror_t DHDDMBCALTruth_factory::Extract_HDDM(s_HDDM_t *hddm_s, vector<void*> &v)
{
