// hnamepath: /Independent/Hist_DetectorPID/BCAL/DeltaTVsP_Proton
// hnamepath: /Independent/Hist_DetectorPID/BCAL/DeltaTVsP_Pi+
// hnamepath: /Independent/Hist_DetectorPID/BCAL/DeltaTVsP_Pi-

{
	...
	if(TVirtualPad::Pad() == NULL)
		locCanvas = new TCanvas("BCALReconstruction_p2", "BCALReconstruction_p2", 1200, 800);
	else
