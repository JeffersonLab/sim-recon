...
#ifndef _DEventProcessor_p2pi_trees_
#define _DEventProcessor_p2pi_trees_
...
#include "DFactoryGenerator_p2pi_trees.h"

using namespace jana;
using namespace std;

class DEventProcessor_p2pi_trees : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_p2pi_trees";}
...
#endif // _DEventProcessor_p2pi_trees_
