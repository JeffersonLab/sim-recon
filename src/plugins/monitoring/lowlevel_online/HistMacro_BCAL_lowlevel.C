// hnamepath: /lowlevel_online/BCAL/bcal_adc_multi
// hnamepath: /lowlevel_online/BCAL/bcal_tdc_multi
// hnamepath: /lowlevel_online/BCAL/bcal_tdc_time
// hnamepath: /lowlevel_online/BCAL/bcal_adc_integral

{
	...
	if(TVirtualPad::Pad() == NULL)
		locCanvas = new TCanvas("BCAL", "BCAL", 1200, 800); //for testing
	else
		locCanvas = gPad->GetCanvas();
	locCanvas->Divide(2, 2);


	TH1I* locHist_ADCmulti = (TH1I*)locDirectory->Get("BCAL/bcal_adc_multi");
	TH1I* locHist_TDCmulti = (TH1I*)locDirectory->Get("BCAL/bcal_tdc_multi");
	TH1I* locHist_TDCtime  = (TH1I*)locDirectory->Get("BCAL/bcal_tdc_time");
	TH1I* locHist_ADCintegral = (TH1I*)locDirectory->Get("BCAL/bcal_adc_integral");
	...
	{
		locHist_ADCintegral->SetTitle("BCAL ADC Integral");
