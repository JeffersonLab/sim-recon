...
//   sprintf(string,"0%03i/bcalled0%03i.root",runnumber1,runnumber1);
   ...
   TFile *run1in = new TFile(infilename.c_str(),"read");
		...
		if (column1_up_peak_vevent1->FindLastBinAbove(0,1) > 100) run1_low_up_1 = (TProfile*)run1in->Get("bcalLED/high_bias_down_column_1_peak_vchannel");

		TProfile *column2_up_peak_vevent1 = (TProfile*)run1in->Get("bcalLED/column2_up_peak_vevent1");
 		if (column2_up_peak_vevent1->FindLastBinAbove(0,1) > 100) run1_low_up_2 = (TProfile*)run1in->Get("bcalLED/high_bias_down_column_2_peak_vchannel");

		TProfile *column3_up_peak_vevent1 = (TProfile*)run1in->Get("bcalLED/column3_up_peak_vevent1");
 		if (column3_up_peak_vevent1->FindLastBinAbove(0,1) > 100) run1_low_up_3 = (TProfile*)run1in->Get("bcalLED/high_bias_down_column_3_peak_vchannel");

		TProfile *column4_up_peak_vevent1 = (TProfile*)run1in->Get("bcalLED/column4_up_peak_vevent1");
 		if (column4_up_peak_vevent1->FindLastBinAbove(0,1) > 100) run1_low_up_4 = (TProfile*)run1in->Get("bcalLED/high_bias_down_column_4_peak_vchannel");
