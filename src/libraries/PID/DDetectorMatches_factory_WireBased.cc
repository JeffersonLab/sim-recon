...
// brun
//------------------
jerror_t DDetectorMatches_factory_WireBased::brun(jana::JEventLoop *locEventLoop, int runnumber)
{
...
// evnt
//------------------
jerror_t DDetectorMatches_factory_WireBased::evnt(jana::JEventLoop* locEventLoop, int eventnumber)
{
