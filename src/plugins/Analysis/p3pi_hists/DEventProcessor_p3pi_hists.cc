...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->AddProcessor(new DEventProcessor_p3pi_hists()); //register this plugin
		locApplication->AddFactoryGenerator(new DFactoryGenerator_p3pi_hists()); //register the factory generator
	}
} // "C"
...
// brun
//------------------
jerror_t DEventProcessor_p3pi_hists::brun(jana::JEventLoop* locEventLoop, int locRunNumber)
{
...
// evnt
//------------------
jerror_t DEventProcessor_p3pi_hists::evnt(jana::JEventLoop* locEventLoop, uint64_t locEventNumber)
{
