...
// brun
//------------------
jerror_t JEventProcessor_CDC_TimeToDistance::brun(JEventLoop *eventLoop, int runnumber)
{
...
// evnt
//------------------
jerror_t JEventProcessor_CDC_TimeToDistance::evnt(JEventLoop *loop, int eventnumber)
{
