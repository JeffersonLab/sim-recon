...
#
# Generation date: Tue Nov 30 15:40:45 EST 2010
# User: gluex
# Host: ifarml6
...
if ( -e /group/halld/Software/builds/sim-recon/sim-recon-2010-11-29/setenv_${BMS_OSNAME}.csh ) then
    # Try prepending path of cwd used in generating this file
    source /group/halld/Software/builds/sim-recon/sim-recon-2010-11-29/setenv_${BMS_OSNAME}.csh
