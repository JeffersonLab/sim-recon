...
jerror_t JEventProcessor_CDC_roc_hits::brun(JEventLoop *eventLoop, int runnumber) {
...
jerror_t JEventProcessor_CDC_roc_hits::evnt(JEventLoop *eventLoop, int eventnumber) {
