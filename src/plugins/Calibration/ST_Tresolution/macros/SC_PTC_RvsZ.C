...
//void st_tw_fits()
{
  ...
  std::ofstream SC_PTC;
  SC_PTC.open ("SCTR_ResVSz.txt", std::ofstream::out);
  //*****************************************************************
  ...
  //*****************************************************************
      ...
      //  for (unsigned int j = 0; j < 1; j++)
    {
      ...
      char* All = Form("h2_CorrectedTime_z_%i",j+1);
	...
	{ 
	  ...
	  SC_PTC <<"\t"<< j+1 <<"\t"<< i+2.5 <<"\t"<< 0.0 <<"\t"<< t_ss_fit_sigma[j][i][2] << "\t"<< t_ss_fit_sigma_err[j][i][2] <<endl;
	}
      //*****************************************************************
      //***********  BS intervals                      ******************
      //*****************************************************************
	  ...
	  Int_t k = i - 39;
      	  ...
      	  SC_PTC <<"\t"<< j+1 <<"\t"<< i+0.5 <<"\t"<< 0.0 <<"\t"<< t_bs_fit_sigma[j][i][2] << "\t"<< t_bs_fit_sigma_err[j][i][2] <<endl;
      	}
	  ...
	  k = (i - 42) - k;
      	  ...
      	  SC_PTC <<"\t"<< j+1 <<"\t"<< i+1 <<"\t"<< 0.0 <<"\t"<< t_ns_fit_sigma[j][i][2] << "\t"<< t_ns_fit_sigma_err[j][i][2] <<endl;
      	}
    }
