...
jerror_t JEventProcessor_TAGH_online::brun(JEventLoop *eventLoop, int runnumber) {
...
jerror_t JEventProcessor_TAGH_online::evnt(JEventLoop *eventLoop, int eventnumber) {
