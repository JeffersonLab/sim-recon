// $Id$
//
//    File: DFactory_DMCTrajectoryPoint.cc
...
// evnt
//------------------
derror_t DFactory_DMCTrajectoryPoint::evnt(DEventLoop *loop, int eventnumber)
{
...
// Extract_HDDM
//------------------
derror_t DFactory_DMCTrajectoryPoint::Extract_HDDM(s_HDDM_t *hddm_s, vector<void*> &v)
{
...
// toString
//------------------
const string DFactory_DMCTrajectoryPoint::toString(void)
{
