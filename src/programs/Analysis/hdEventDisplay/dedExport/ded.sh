...
CLASSPATH=./bin/ded/ded.jar:./bin/bCNU/bCNU.jar:./bin/jevio/jevio.jar:./bin/bCNU/bcnuimages.jar
echo $CLASSPATH

$JAVA_HOME/bin/java -Xmx256M -Xss512k -cp $CLASSPATH  cnuphys.ded.frame.Ded
