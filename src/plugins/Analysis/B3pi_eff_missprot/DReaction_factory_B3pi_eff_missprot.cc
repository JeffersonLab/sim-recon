// $Id$
//
//    File: DReaction_factory_B3pi_eff_missprot.cc
...
// brun
//------------------
jerror_t DReaction_factory_B3pi_eff_missprot::brun(JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DReaction_factory_B3pi_eff_missprot::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	/************************************************** B3pi_eff_missprot Reaction Definition *************************************************/

	locReaction = new DReaction("B3pi_eff_missprot");
...
*/
        ...
        locReaction->Enable_TTreeOutput("tree_pippimpi0_eff_missprot.root", true); //true/false: do/don't save unused hypotheses
...
//        locReaction->Add_AnalysisAction(new DCutAction_MissingMassSquared(locReaction, false, -1.02, 1.02));
...
//        locReaction->Add_AnalysisAction(new DCustomAction_dEdxCut(locReaction, true)); //true: focus on rejecting background
        ...
        locReaction->Add_AnalysisAction(new DCutAction_KinFitFOM(locReaction, 1e-7)); //require kinematic fit to converge
...
// fini
//------------------
jerror_t DReaction_factory_B3pi_eff_missprot::fini(void)
{
