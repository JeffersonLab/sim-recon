...
class ostream
{
	...
	public:
		...
		ostream& operator<<(const int32_t v);
		//ostream& operator<<(const int v);
		ostream& operator<<(const uint32_t v);
		//ostream& operator<<(const unsigned int v);
		ostream& operator<<(const int64_t v);
		//ostream& operator<<(const long int v);
		ostream& operator<<(const uint64_t v);
		//ostream& operator<<(const unsigned long v);
		ostream& operator<<(const float v);
		ostream& operator<<(const double v);
