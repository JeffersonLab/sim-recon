...
//  should match functionally that of the default class.  It is suggested we make further revisions
//  and tuning to this factory and then eventually replace the default with this one.
//  Since some of the optimization revisions were rather dramatic, I was hesitant to replace the
//  default class at this point.  Once this code has been throughly vetted we can use it
//  as default.
//
