// $Id$
//
//    File: DReaction_factory_B3pi_eff_misspim.cc
...
// brun
//------------------
jerror_t DReaction_factory_B3pi_eff_misspim::brun(JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DReaction_factory_B3pi_eff_misspim::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	/************************************************** B3pi_eff_misspim Reaction Definition *************************************************/

	locReaction = new DReaction("B3pi_eff_misspim");
...
*/
        ...
        locReaction->Enable_TTreeOutput("tree_pippimpi0_eff_misspim.root", true); //true/false: do/don't save unused hypotheses
...
// fini
//------------------
jerror_t DReaction_factory_B3pi_eff_misspim::fini(void)
{
