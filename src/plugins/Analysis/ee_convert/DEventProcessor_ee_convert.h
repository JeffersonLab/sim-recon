...
#include "DFactoryGenerator_ee_convert.h"

using namespace jana;
using namespace std;

class DEventProcessor_ee_convert : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_ee_convert";}
...
#endif // _DEventProcessor_ee_convert_
