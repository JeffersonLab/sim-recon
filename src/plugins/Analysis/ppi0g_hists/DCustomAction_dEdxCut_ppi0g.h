// $Id$
//
//    File: DCustomAction_dEdxCut_ppi0g.h
// Created: Thu Oct  1 11:18:05 EDT 2015
// Creator: pmatt (on Darwin Pauls-MacBook-Pro-2.local 13.4.0 i386)
//

#ifndef _DCustomAction_dEdxCut_ppi0g_
#define _DCustomAction_dEdxCut_ppi0g_
...
class DCustomAction_dEdxCut_ppi0g : public DAnalysisAction
{
	public:

		DCustomAction_dEdxCut_ppi0g(const DReaction* locReaction, bool locMaxRejectionFlag = false, string locActionUniqueString = "") :
...
#endif // _DCustomAction_dEdxCut_ppi0g_
