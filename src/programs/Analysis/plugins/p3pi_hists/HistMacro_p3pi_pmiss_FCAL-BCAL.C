// hnamepath: /p3pi_pmiss_FCAL-BCAL/Custom_p3pi_hists_NoKinFit_Measured/MM_M3pi
// hnamepath: /p3pi_pmiss_FCAL-BCAL/Custom_p3pi_hists_KinFitCut10_Measured/MM_M3pi
// hnamepath: /p3pi_pmiss_FCAL-BCAL/Hist_InvariantMass_NoKinFit_Measured/InvariantMass

{
	...
	TDirectory *locDirectory = (TDirectory*)locReactionDirectory->FindObjectAny("Custom_p3pi_hists_NoKinFit_Measured_Measured");
	if(!locDirectory)
		return;
	locDirectory->cd();
