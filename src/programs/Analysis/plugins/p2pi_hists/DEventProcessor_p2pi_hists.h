...
class DEventProcessor_p2pi_hists : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_p2pi_hists";}
...
#endif // _DEventProcessor_p2pi_hists_
