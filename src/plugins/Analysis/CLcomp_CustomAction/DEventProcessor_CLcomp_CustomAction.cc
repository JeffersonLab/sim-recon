...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->AddProcessor(new DEventProcessor_CLcomp_CustomAction()); //register this plugin
		locApplication->AddFactoryGenerator(new DFactoryGenerator_CLcomp_CustomAction()); //register the factory generator
	}
} // "C"
...
// init
//------------------
jerror_t DEventProcessor_CLcomp_CustomAction::init(void)
{
...
// brun
//------------------
jerror_t DEventProcessor_CLcomp_CustomAction::brun(jana::JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DEventProcessor_CLcomp_CustomAction::evnt(jana::JEventLoop* locEventLoop, uint64_t locEventNumber)
{
...
int DEventProcessor_CLcomp_CustomAction::Get_FileNumber(JEventLoop* locEventLoop) const
{
...
// erun
//------------------
jerror_t DEventProcessor_CLcomp_CustomAction::erun(void)
{
...
// fini
//------------------
jerror_t DEventProcessor_CLcomp_CustomAction::fini(void)
{
