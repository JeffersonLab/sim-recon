...
// hnamepath: /occupancy/fdc_cathode_occ_2
// hnamepath: /occupancy/fdc_wire__occ_2

{
	...
	TH2F *fdc_cathode_occ = (TH2F*)gDirectory->FindObjectAny("fdc_cathode_occ_2");
	TH2F *fdc_wire_occ = (TH2F*)gDirectory->FindObjectAny("fdc_wire_occ_2");
