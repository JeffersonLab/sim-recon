...

{
  ...
  char string[256];
    ...
    TString filename = "hd_rawdata_010707_000";
   ...
   h1trig_trgbits->Draw("");
    ...
    TLine *thresh_fb = new TLine(0,thf,thb,0);
    ...
    t1->DrawLatex(0.05,0.6,string);
    
    sprintf (string,"001\n");
    t1->DrawLatex(0.15,0.4,string);
   ...
   sprintf (string,"trig_fcalbcal3.pdf(");
   c0->SaveAs(string);
   sprintf (string,"trig_fcalbcal3.pdf");
   c1->SaveAs(string);
   sprintf (string,"trig_fcalbcal3.pdf");
