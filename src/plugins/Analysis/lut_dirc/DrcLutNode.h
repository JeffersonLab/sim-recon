...
public:    
  ...
  // Modifiers
  void AddEntry(Int_t lutId, Int_t nodeId, TVector3 dir, Double_t pathid, Int_t nrefl, Double_t time, TVector3 hitpos, TVector3 digipos,  Double_t weight=1);
  void AddEntry(Int_t lutId, Int_t nodeId, TVector3 dir, Double_t pathid, Int_t nrefl, Double_t time, TVector3 hitpos, TVector3 digipos,  Double_t weight,
