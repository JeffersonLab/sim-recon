// $Id: Df250PulsePedestal.h 16643 2014-11-24 21:17:40Z davidl $
// $HeadURL: https://halldsvn.jlab.org/repos/branches/sim-recon-commissioning/src/programs/Utilities/plugins/DAQ/Df250PulsePedestal.h $
//
...
class Df250PulsePedestal:public DDAQAddress{
	...
	public:
		...
		Df250PulsePedestal(uint32_t rocid=0, uint32_t slot=0, uint32_t channel=0, uint32_t itrigger=0, uint32_t pulse_number=0, uint32_t pedestal=0, uint32_t pulse_peak=0,bool emulated=false):DDAQAddress(rocid, slot, channel, itrigger),pulse_number(pulse_number),pedestal(pedestal),pulse_peak(pulse_peak),emulated(emulated){}
