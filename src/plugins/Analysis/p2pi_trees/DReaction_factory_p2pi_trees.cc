...
#include "DReaction_factory_p2pi_trees.h"

//------------------
// brun
//------------------
jerror_t DReaction_factory_p2pi_trees::brun(JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DReaction_factory_p2pi_trees::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
  {
	// DOCUMENTATION:
	// ANALYSIS library: https://halldweb1.jlab.org/wiki/index.php/GlueX_Analysis_Software
	// DReaction factory: https://halldweb1.jlab.org/wiki/index.php/Analysis_DReaction

	/************************************************** p2pi_trees Reaction Definition *************************************************/
	...
	locReaction->Enable_TTreeOutput("tree_p2pi_trees.root", false); //true/false: do/don't save unused hypotheses

	/************************************************** p2pi_trees Pre-Combo Custom Cuts *************************************************/
...
// fini
//------------------
jerror_t DReaction_factory_p2pi_trees::fini(void)
{
