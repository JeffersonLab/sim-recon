// hnamepath: /lowlevel_online/FCAL/fcal_adc_multi
// hnamepath: /lowlevel_online/FCAL/fcal_adc_pedestal
// hnamepath: /lowlevel_online/FCAL/fcal_adc_time
// hnamepath: /lowlevel_online/FCAL/fcal_adc_integral

{
	...
	if(TVirtualPad::Pad() == NULL)
		locCanvas = new TCanvas("FCAL", "FCAL", 1200, 800); //for testing
	else
		locCanvas = gPad->GetCanvas();
	locCanvas->Divide(2, 2);


	TH1I* locHist_ADCmulti = (TH1I*)locDirectory->Get("FCAL/fcal_adc_multi");
	TH1I* locHist_ADCpedestal = (TH1I*)locDirectory->Get("FCAL/fcal_adc_pedestal");
	TH1I* locHist_ADCtime  = (TH1I*)locDirectory->Get("FCAL/fcal_adc_time");
	TH1I* locHist_ADCintegral = (TH1I*)locDirectory->Get("FCAL/fcal_adc_integral");
	...
	{
		locHist_ADCmulti->SetTitle("FCAL ADC Multiplicity");
	...
	{
		locHist_ADCpedestal->SetTitle("FCAL ADC Pedestal");
	...
	{
		locHist_ADCintegral->SetTitle("FCAL ADC Integral");
	...
	{
		locHist_ADCtime->SetTitle("FCAL ADC Time");
