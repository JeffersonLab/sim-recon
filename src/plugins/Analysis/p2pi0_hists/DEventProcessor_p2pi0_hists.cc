...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->AddProcessor(new DEventProcessor_p2pi0_hists()); //register this plugin
		locApplication->AddFactoryGenerator(new DFactoryGenerator_p2pi0_hists()); //register the factory generator
	}
} // "C"
...
// init
//------------------
jerror_t DEventProcessor_p2pi0_hists::init(void)
{
...
// brun
//------------------
jerror_t DEventProcessor_p2pi0_hists::brun(jana::JEventLoop* locEventLoop, int locRunNumber)
{
...
// evnt
//------------------
jerror_t DEventProcessor_p2pi0_hists::evnt(jana::JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	const DEventWriterROOT* locEventWriterROOT = NULL;
	locEventLoop->GetSingle(locEventWriterROOT);
	locEventWriterROOT->Fill_DataTrees(locEventLoop, "p2pi0_hists");
	*/
...
// erun
//------------------
jerror_t DEventProcessor_p2pi0_hists::erun(void)
{
...
// fini
//------------------
jerror_t DEventProcessor_p2pi0_hists::fini(void)
{
