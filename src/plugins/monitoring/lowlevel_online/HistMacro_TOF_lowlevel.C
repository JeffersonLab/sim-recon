// hnamepath: /lowlevel_online/TOF/tof_adc_multi
// hnamepath: /lowlevel_online/TOF/tof_tdc_multi
// hnamepath: /lowlevel_online/TOF/tof_tdc_time
// hnamepath: /lowlevel_online/TOF/tof_adc_integral

{
	...
	if(TVirtualPad::Pad() == NULL)
		locCanvas = new TCanvas("TOF", "TOF", 1200, 800); //for testing
	else
		locCanvas = gPad->GetCanvas();
	locCanvas->Divide(2, 2);


	TH1I* locHist_ADCmulti = (TH1I*)locDirectory->Get("TOF/tof_adc_multi");
	TH1I* locHist_TDCmulti = (TH1I*)locDirectory->Get("TOF/tof_tdc_multi");
	TH1I* locHist_TDCtime  = (TH1I*)locDirectory->Get("TOF/tof_tdc_time");
	TH1I* locHist_ADCintegral = (TH1I*)locDirectory->Get("TOF/tof_adc_integral");
	...
	{
		locHist_ADCmulti->SetTitle("TOF ADC Multiplicity");
	...
	{
		locHist_TDCmulti->SetTitle("TOF TDC Multiplicity");
	...
	{
		locHist_ADCintegral->SetTitle("TOF ADC Integral");
		//locHist_ADCintegral->Rebin(2);
		locHist_ADCintegral->GetXaxis()->SetRangeUser(2000.0, 10000.);
	...
	{
		locHist_TDCtime->SetTitle("TOF TDC Time");
		//locHist_TDCtime->Rebin(2);
		locHist_TDCtime->GetXaxis()->SetRangeUser(0, 1000);
