// $Id$
//
//    File: DEventProcessor_B3pi_eff_misspim.h
// Created: Fri Jun 30 00:38:16 EDT 2017
// Creator: jmhardin (on Linux ifarm1402.jlab.org 3.10.0-327.el7.x86_64 x86_64)
//

#ifndef _DEventProcessor_B3pi_eff_misspim_
#define _DEventProcessor_B3pi_eff_misspim_
...
#include "DFactoryGenerator_B3pi_eff_misspim.h"

using namespace jana;
using namespace std;

class DEventProcessor_B3pi_eff_misspim : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_B3pi_eff_misspim";}
...
#endif // _DEventProcessor_B3pi_eff_misspim_
