// $Id$
//
//    File: DCustomAction_dEdxCut_ppi0gamma.h
// Created: Thu Oct  1 11:18:05 EDT 2015
// Creator: pmatt (on Darwin Pauls-MacBook-Pro-2.local 13.4.0 i386)
//

#ifndef _DCustomAction_dEdxCut_ppi0gamma_
#define _DCustomAction_dEdxCut_ppi0gamma_
...
class DCustomAction_dEdxCut_ppi0gamma : public DAnalysisAction
{
	public:

		DCustomAction_dEdxCut_ppi0gamma(const DReaction* locReaction, bool locMaxRejectionFlag = false, string locActionUniqueString = "") :
...
#endif // _DCustomAction_dEdxCut_ppi0gamma_
