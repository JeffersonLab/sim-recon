...
jerror_t DReaction_factory_p2k::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	*/
	...
	// For histogramming the phi mass
	std::deque<Particle_t> MyPhi;
        MyPhi.push_back(KPlus); MyPhi.push_back(KMinus);

	// HISTOGRAM PID
	locReaction->Add_AnalysisAction(new DHistogramAction_PID(locReaction));
	locReaction->Add_AnalysisAction(new DHistogramAction_InvariantMass(locReaction, 0, MyPhi, false, 1000, 0.9, 2.4, "Initial"));
	...
	locReaction->Add_AnalysisAction(new DCutAction_PIDDeltaT(locReaction, false, 0.60, Proton, SYS_TOF));  //false: measured data
        ...
        locReaction->Add_AnalysisAction(new DCutAction_PIDDeltaT(locReaction, false, 0.30, KPlus, SYS_TOF));   //false: measured data
        ...
        locReaction->Add_AnalysisAction(new DCutAction_PIDDeltaT(locReaction, false, 0.30, KMinus, SYS_TOF));  //false: measured data
	...
	locReaction->Add_AnalysisAction(new DHistogramAction_InvariantMass(locReaction, 0, MyPhi, false, 1000, 0.9, 2.4, "Post_timing"));
	...
	//locReaction->Add_AnalysisAction(new DCustomAction_CLcomp(locReaction)); // apply CL comparision custom action
	locReaction->Add_AnalysisAction(new DCustomAction_CLcomp(locReaction, true)); // apply CL comparision custom action
	locReaction->Add_AnalysisAction(new DHistogramAction_InvariantMass(locReaction, 0, MyPhi, false, 1000, 0.9, 2.4, "Post_CLcomp"));
