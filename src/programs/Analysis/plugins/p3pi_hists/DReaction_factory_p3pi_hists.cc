...
jerror_t DReaction_factory_p3pi_hists::init(void)
{
	...
	/**************************************************** p3pi_pmiss_2FCAL Reaction Steps ****************************************************/
	...
	/**************************************************** p3pi_pmiss_2FCAL Control Settings ****************************************************/
	...
	// Require one match between SC and Tagger photon
        locReaction->Add_AnalysisAction(new DCustomAction_p3pi_taggerCoincidence(locReaction, false, maxDeltaT));
	...
	// Require KinFit FOM > 0.1
        ...
        // Custom histograms for p3pi (after KinFit FOM > 10%)
        locReaction->Add_AnalysisAction(new DCustomAction_p3pi_hists(locReaction, false, "KinFitCut10_Measured"));
	locReaction->Add_AnalysisAction(new DCustomAction_p3pi_hists(locReaction, true, "KinFitCut10_KinFit"));
	...
	/**************************************************** p3pi_pmiss_FCAL-BCAL Reaction Steps ****************************************************/

	locReaction = new DReaction("p3pi_pmiss_FCAL-BCAL"); //needs to be a unique name for each DReaction object, CANNOT (!) be "Thrown"
	...
	locReaction->Add_ReactionStep(dReactionStepPool[3]);
	locReaction->Add_ReactionStep(dReactionStepPool[1]);
	locReaction->Add_ReactionStep(dReactionStepPool[2]);
