// $Id$
//
//    File: DCustomAction_p2pi_taggerCoincidence.cc
...
void DCustomAction_p2pi_taggerCoincidence::Initialize(JEventLoop* locEventLoop)
{
...
bool DCustomAction_p2pi_taggerCoincidence::Perform_Action(JEventLoop* locEventLoop, const DParticleCombo* locParticleCombo)
{
