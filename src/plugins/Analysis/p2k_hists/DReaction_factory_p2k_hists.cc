...
jerror_t DReaction_factory_p2k_hists::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	/**************************************************** p2k_preco_kinfit Reaction Steps ****************************************************/

	locReaction = new DReaction("p2k_preco_kinfit"); //needs to be a unique name for each DReaction object, CANNOT (!) be "Thrown"

	// g, p -> k+, k- ,p
	locReaction->Add_ReactionStep(locReactionStep);

	/**************************************************** p2k_preco_kinfit Control Settings ****************************************************/
