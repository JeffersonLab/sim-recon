 ...
 * 
 *  This class provides an interface to the magnetic field map that is created
 *  for the Solenoid used in this project.  The current implementation reads
...
class DMagneticFieldMap
{
  ...
  public:
    ...
    /*!
     * Methods to read a solenoid map from a file.
