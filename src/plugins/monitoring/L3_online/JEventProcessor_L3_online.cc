...
jerror_t JEventProcessor_L3_online::brun(JEventLoop *eventLoop, int runnumber) {
...
jerror_t JEventProcessor_L3_online::evnt(JEventLoop *eventLoop, int eventnumber) {
