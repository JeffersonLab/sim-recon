// hnamepath: /Independent/Hist_DetectorPID/FCAL/DeltaTVsP_Proton
// hnamepath: /Independent/Hist_DetectorPID/FCAL/DeltaTVsP_Pi+
// hnamepath: /Independent/Hist_DetectorPID/FCAL/DeltaTVsP_Pi-

{
	...
	if(TVirtualPad::Pad() == NULL)
		locCanvas = new TCanvas("FCALReconstruction_p2", "FCALReconstruction_p2", 1200, 800);
	else
