...
class Particle{
	public:
		Particle():type(Unknown),pdgtype(0),parentid(0),mech(0),decayVertex(0){p.SetXYZT(0,0,0,0);}
...
class Event{
	public:
		Event():runNo(0),eventNo(0),reaction_type(0),reaction_weight(0){vertex.SetXYZ(0,0,0);}
