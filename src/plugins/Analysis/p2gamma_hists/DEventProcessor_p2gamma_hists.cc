// $Id$
//
//    File: DEventProcessor_p2gamma_hists.cc
// Created: Tue Apr 28 21:19:41 EDT 2015
// Creator: jrsteven (on Linux ifarm1401 2.6.32-431.el6.x86_64 x86_64)
//

#include "DEventProcessor_p2gamma_hists.h"
...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->AddProcessor(new DEventProcessor_p2gamma_hists()); //register this plugin
		locApplication->AddFactoryGenerator(new DFactoryGenerator_p2gamma_hists()); //register the factory generator
	}
} // "C"
...
// init
//------------------
jerror_t DEventProcessor_p2gamma_hists::init(void)
{
...
// evnt
//------------------
jerror_t DEventProcessor_p2gamma_hists::evnt(jana::JEventLoop* locEventLoop, uint64_t locEventNumber)
{
...
// erun
//------------------
jerror_t DEventProcessor_p2gamma_hists::erun(void)
{
...
// fini
//------------------
jerror_t DEventProcessor_p2gamma_hists::fini(void)
{
