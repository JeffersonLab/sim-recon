...
int main(int argC, char* argV[])
{
   ...
   hFile << "/*"						<< endl
	 ...
	 << " *"						<< endl
	 << " * This file was generated automatically from the"
	 << " file " << xmlFile << " by hddm-c."		<< endl
         << " * This header file defines the c structures that"
	 << " hold the data described"				<< endl
	 << " * in the data model (from " << xmlFile << "). "
	 << " Any program that needs access to the"		<< endl
	 << " * data described in the model can include"
	 << " this header file, and make use"			<< endl
	 << " * of the input/output services provided in"
	 << cname						<< endl
	 << " *"						<< endl
   ...
   cFile << "/*"						<< endl
	 ...
	 << " * This file was generated automatically from the"
	 << " file " << xmlFile << " by hddm-c."		<< endl
         << " * This c file contains the i/o interface to the"
	 << " c structures described"				<< endl
	 << " * in the data model (from " << xmlFile << "). "
	 << " Any program that needs access to the"		<< endl
	 << " * data described in the model can compile"
	 << " this c source file, and make use"			<< endl
	 << " * of the input/output services provided."		<< endl
	 << " *"						<< endl
	 << " * The hddm data model tool set was written by"	<< endl
	 << " * Richard Jones, University of Connecticut."	<< endl
	 << " *"						<< endl
