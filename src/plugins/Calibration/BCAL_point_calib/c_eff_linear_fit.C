void c_eff_linear_fit(void)
{
// macro that gets TGraphs from the ROOT file generated from the BCAL_point_calibs plugin and returns the effective velocities for each channel, using a linear fit
...
gROOT->Reset();
	...
	// use this if you want the old effective velocity value
        // float effective_velocity = 16.75;
