...
#ifndef _DReaction_factory_p2pi_trees_
#define _DReaction_factory_p2pi_trees_
...
class DReaction_factory_p2pi_trees : public jana::JFactory<DReaction>
{
	public:
		...
		const char* Tag(void){return "p2pi_trees";}
...
#endif // _DReaction_factory_p2pi_trees_
