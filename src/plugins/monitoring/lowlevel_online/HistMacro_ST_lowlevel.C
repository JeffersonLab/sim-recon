// hnamepath: /lowlevel_online/ST/st_adc_multi
// hnamepath: /lowlevel_online/ST/st_tdc_multi
// hnamepath: /lowlevel_online/ST/st_tdc_time
// hnamepath: /lowlevel_online/ST/st_adc_integral

{
	...
	if(TVirtualPad::Pad() == NULL)
		locCanvas = new TCanvas("st", "st", 1200, 800); //for testing
	else
		locCanvas = gPad->GetCanvas();
	locCanvas->Divide(2, 2);


	TH1I* locHist_ADCmulti = (TH1I*)locDirectory->Get("ST/st_adc_multi");
	TH1I* locHist_TDCmulti = (TH1I*)locDirectory->Get("ST/st_tdc_multi");
	TH1I* locHist_TDCtime  = (TH1I*)locDirectory->Get("ST/st_tdc_time");
	TH1I* locHist_ADCintegral = (TH1I*)locDirectory->Get("ST/st_adc_integral");
	...
	{
		locHist_ADCmulti->SetTitle("ST ADC Multiplicity");
		...
		locHist_ADCmulti->GetXaxis()->SetRangeUser(0.0, 40.);
	...
	{
		locHist_TDCmulti->SetTitle("ST TDC Multiplicity");
		...
		locHist_TDCmulti->GetXaxis()->SetRangeUser(0.0, 40.);
	...
	{
		locHist_ADCintegral->SetTitle("ST ADC Integral");
		//locHist_ADCintegral->Rebin(2);
		locHist_ADCintegral->GetXaxis()->SetRangeUser(2000.0, 4000.);
