...
//   sprintf(string,"0%03i/bcalled0%03i.root",runnumber1,runnumber1);
   ...
   TFile *run1in = new TFile(infilename.c_str(),"read");
		...
		run1_low_up_1 = (TProfile*)run1in->Get("bcalLED/low_bias_up_column_1_peak_vchannel");
		run1_low_up_2 = (TProfile*)run1in->Get("bcalLED/low_bias_up_column_2_peak_vchannel");
		run1_low_up_3 = (TProfile*)run1in->Get("bcalLED/low_bias_up_column_3_peak_vchannel"); 
		run1_low_up_4 = (TProfile*)run1in->Get("bcalLED/low_bias_up_column_4_peak_vchannel");
		...
		run1_high_down_1 = (TProfile*)run1in->Get("bcalLED/high_bias_down_column_1_peak_vchannel");
		run1_high_down_2 = (TProfile*)run1in->Get("bcalLED/high_bias_down_column_2_peak_vchannel");
		run1_high_down_3 = (TProfile*)run1in->Get("bcalLED/high_bias_down_column_3_peak_vchannel");
		run1_high_down_4 = (TProfile*)run1in->Get("bcalLED/high_bias_down_column_4_peak_vchannel");
		...
		run1_low_up_1_hist->SetTitle("6v Upstream column 1");
		run1_low_up_2_hist->SetTitle("6v Upstream column 2");
		run1_low_up_3_hist->SetTitle("6v Upstream column 3"); 
		run1_low_up_4_hist->SetTitle("6v Upstream column 4");
		...
		run1_high_down_1_hist->SetTitle("6.25v Downstream column 1");
		run1_high_down_2_hist->SetTitle("6.25v Downstream column 2");
		run1_high_down_3_hist->SetTitle("6.25v Downstream column 3");
		run1_high_down_4_hist->SetTitle("6.25v Downstream column 4");
